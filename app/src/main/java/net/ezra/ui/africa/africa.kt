...
@Composable
fun Africa(navController: NavHostController){
                        ...
                        Row {
                            Column{
                                ...
                                Card(
                                    ...
                                    Image(painter = painterResource(id = R.drawable.pyriamid),
                                        contentDescription = null,
                                        modifier = Modifier
                                            .fillMaxSize(),
                                        contentScale = ContentScale.Crop
                                ...
                                Card(
                                    ...
                                    Image(painter = painterResource(id = R.drawable.ethiopia),
                                        contentDescription = null,
                                        modifier = Modifier
                                            .fillMaxSize(),
                                        contentScale = ContentScale.Crop
...
@Composable
fun PreviewLight() {
    net.ezra.ui.africa.Africa(rememberNavController())
}